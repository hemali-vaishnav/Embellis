...
export default function Header() {
  ...
  bg-[#fffaf0]/65 backdrop-blur-md backdrop-saturate-150
  shadow-sm
  ...
  `}
      ...
      <div className="relative mx-auto h-[125px] px-14  grid grid-cols-[1fr_auto_1fr] items-center py-2">
        ...
        <div className="flex justify-end items-center gap-6">
          ...
          {/* Search */}
          <div className="hidden md:flex items-center gap-2 px-3 py-2 border rounded-xl border-[#3d2b1a]/15  backdrop-blur-sm w-full max-w-[250px]">
            <IoIosSearch className="w-6 h-6 text-[#3d2b1a]/70" />
            <input
              type="text"
              value={searchQuery}
